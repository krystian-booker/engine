...
TEST_CASE("PartyManager add/remove companions", "[companion][party]") {
...
TEST_CASE("PartyManager commands", "[companion][party]") {
    PartyTestFixture fixture;
    fixture.setup_party_manager();
    auto& pm = party_manager();
...
TEST_CASE("PartyManager formation", "[companion][party]") {
    PartyTestFixture fixture;
    fixture.setup_party_manager();
    auto& pm = party_manager();
...
TEST_CASE("PartyManager queries", "[companion][party]") {
    PartyTestFixture fixture;
    fixture.setup_party_manager();
    auto& pm = party_manager();
...
TEST_CASE("PartyManager serialization", "[companion][party]") {
    PartyTestFixture fixture;
    fixture.setup_party_manager();
    auto& pm = party_manager();
...
TEST_CASE("PartyManager callbacks", "[companion][party]") {
    PartyTestFixture fixture;
    fixture.setup_party_manager();
    auto& pm = party_manager();
...
TEST_CASE("PartyManager debug info", "[companion][party]") {
    PartyTestFixture fixture;
    fixture.setup_party_manager();
    auto& pm = party_manager();

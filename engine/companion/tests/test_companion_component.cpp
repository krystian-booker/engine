...
TEST_CASE("CompanionComponent state management", "[companion]") {
...
TEST_CASE("CompanionComponent settings", "[companion]") {
    CompanionComponent comp;
...
TEST_CASE("CompanionComponent state queries", "[companion]") {
    CompanionComponent comp;
...
TEST_CASE("CompanionState string conversion", "[companion]") {

...
TEST_CASE("Formation slot calculation", "[companion][formation]") {
...
TEST_CASE("Formation position calculation", "[companion][formation]") {
    Formation f = Formation::wedge(4, 2.0f);
...
TEST_CASE("Formation slot management", "[companion][formation]") {
    Formation f = Formation::wedge(4, 2.0f);
...
TEST_CASE("Formation type string conversion", "[companion][formation]") {

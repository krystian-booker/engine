...
protected:
    ...
    // Access settings
    core::ProjectSettings& settings() { return core::ProjectSettings::get(); }

    // Window management (platform specific)
    bool create_window(const core::WindowSettings& settings);
    void destroy_window();
    ...
    core::GameClock& clock() { return m_clock; }

    // Parse command line arguments
    void parse_args(int argc, char** argv);

private:
    core::GameClock m_clock;
    ...
    core::WindowBackend m_window_backend = core::WindowBackend::X11;
    std::unique_ptr<core::PlatformWindow> m_platform_window;
